        ...
        <div class="lg:col-span-2 bg-white p-8 shadow border">
            ...
            <form action="{{ route('booking.store') }}" method="POST" class="space-y-8">
                ...
                <div>
                    ...
                    <label class="block mb-2">Choose Service</label>

                    <select name="service_id" class="w-full border p-3 rounded" required>
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        rows="4"
                        class="w-full border p-3 rounded"
                        placeholder="Optional requests or preferences">
                    </textarea>
